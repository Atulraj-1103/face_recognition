...
trainingSet = trainDataGen.flow_from_directory(r'C:\Users\KIIT\Desktop\mlops_ws\face\data\train', target_size = (224, 224))

testSet = testDataGen.flow_from_directory(r'C:\Users\KIIT\Desktop\mlops_ws\face\val', target_size = (224, 224))


r = model.fit_generator(steps_per_epoch=100, epochs=3, validation_steps=10,
                        generator=trainingSet,validation_data=testSet,)


model.save('face_actor_VGG_TL.h5')
